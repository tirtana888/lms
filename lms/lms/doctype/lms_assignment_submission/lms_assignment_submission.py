...
class LMSAssignmentSubmission(Document):
	...
	def validate_schedule_window(self):
		"""Students cannot create or edit submission content outside the
		assignment's scheduling window. Privileged roles may still grade
		(and manage submissions) outside the schedule.
		"""
